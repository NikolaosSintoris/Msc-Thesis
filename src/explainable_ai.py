...
def create_shap_test_dataset(test_df):
    ...
    print("X test shap np: {}".format(X_test_shap_np))
...
def compute_shap_values(model, X_train, X_test_shap):
    ...
    kmeans_obj = KMeans(n_clusters=25, init='k-means++', random_state=0, n_init="auto").fit(X_train)
...
if __name__ == '__main__':
    ...
    # Create datasets
    X_train_1, y_train_1, X_train_2, y_train_2, X_train_3, y_train_3, X_train_4, y_train_4, X_train_5, y_train_5, X_test, y_test = create_supervised_train_test_sets(
