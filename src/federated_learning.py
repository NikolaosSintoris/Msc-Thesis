...
def create_supervised_train_test_sets(train_df1, train_df2, train_df3, train_df4, train_df5, test_df):
    '''
...
def train_model(model, X_train, y_train, X_validation, y_validation):
    '''
        ...
        Return:
            the weights of the model after training, training and validation loss
    '''
...
def training_results_line_plot(train_loss_lst, validation_loss_lst):
    '''
        Create a training and validation loss plot.
    '''
    # Create a loss plot.
...
if __name__ == '__main__':
    ...
    X_train_1, y_train_1, X_train_2, y_train_2, X_train_3, y_train_3, X_train_4, y_train_4, X_train_5, y_train_5, X_test, y_test = create_supervised_train_test_sets(train_df1, train_df2, train_df3, train_df4, train_df5, test_df)
    ...
    # Train client models in non federated approach
    print("Train client in non-federated approach")
    # Fix path.
